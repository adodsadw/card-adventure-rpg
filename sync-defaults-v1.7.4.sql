...
VALUES
('aria','烈焰劍士・亞莉雅','稀有','火','戰士','擅長單體爆發與暴擊的前排劍士','/assets/heroes/aria.svg',520,88,18,150,1.0,100,1),
('mira','冰霜法師・米菈','史詩','水','法師','使用寒冰魔法造成高額魔法傷害','/assets/heroes/mira.svg',390,118,10,150,1.0,100,1),
('gorn','鋼鐵守衛・戈恩','稀有','土','守衛','以高生命與防禦保護隊伍','/assets/heroes/gorn.svg',760,62,28,150,1.0,100,1),
('luna','月光祭司・露娜','史詩','光','祭司','攻擊時有機會治療生命最低的隊友','/assets/heroes/luna.svg',470,92,14,180,1.0,100,1),
('kael','暗影刺客・凱爾','傳說','暗','刺客','擁有高攻擊與高暴擊的單體輸出','/assets/heroes/kael.svg',410,145,8,240,1.1,100,1),
('elwyn','森林弓手・艾爾雯','稀有','木','弓手','穩定且精準的遠程攻擊英雄','/assets/heroes/elwyn.svg',430,104,11,150,1.0,100,1),
('sol','聖光騎士・索爾','傳說','光','騎士','兼具生命與神聖傷害的傳說英雄','/assets/heroes/sol.svg',650,120,22,240,1.1,100,1),
('nyx','夜語術士・妮克絲','史詩','暗','術士','以虛空魔法強化暴擊並侵蝕敵人','/assets/heroes/nyx.svg',420,128,9,180,1.0,100,1);
...
VALUES
('shop-energy-potion','體力藥水','energyPotion','/assets/shop/energyPotion.svg','gold',600,5,0,0,1),
('shop-heal-potion','治療藥水','potion','/assets/shop/potion.svg','gold',300,5,0,0,1),
('shop-wood','古木碎片','wood','/assets/shop/wood.svg','gold',180,5,0,0,1),
('shop-ore','星鐵礦石','ore','/assets/shop/ore.svg','gold',260,5,0,0,1),
('shop-herb','月光藥草','herb','/assets/shop/herb.svg','gold',220,5,0,0,1),
('shop-sword','星鐵長劍','sword','/assets/shop/sword.svg','gold',1800,1,0,0,1),
('shop-armor','守衛胸甲','armor','/assets/shop/armor.svg','gold',2200,1,0,0,1);
