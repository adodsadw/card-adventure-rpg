...
banners:{title:"首頁 Banner",endpoint:"banners",fields:[["id","Banner ID","text","唯一代號"],["title","標題","text","Banner 標題"],["subtitle","副標題","text","簡短說明"],["image_url","圖片","media","1920×720 JPG/WebP、2MB 以下"],["link_target","點擊目標","text","顯示於前台首頁最上方；點擊後可前往 shopPage、announcementPage 等頁面"],["starts_at","開始時間","datetime-local","留空立即"],["ends_at","結束時間","datetime-local","留空永久"],["sort_order","排序","number","越小越前"],["active","啟用","checkbox","是否顯示"]]}}
