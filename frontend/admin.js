...
announcements:{title:"公告系統",endpoint:"announcements",fields:[["id","公告 ID","text","唯一代號"],["title","標題","text","首頁顯示"],["body","內容","textarea","更新內容"],["image_url","公告圖片","media","1200×630 JPG/WebP、1MB 以下"],["starts_at","開始時間","datetime-local","留空立即"],["ends_at","結束時間","datetime-local","留空永久"],["priority","優先順序","number","越大越前"],["active","啟用","checkbox","是否顯示"]]},
